...
enum class FarmUiError(@StringRes val resourceId: Int) {
    ...
    AMOUNT_POSITIVE_WHOLE(R.string.error_transaction_amount_positive_whole),
    CURRENCY_ISO_THREE_LETTERS(R.string.error_currency_iso_three_letters),
    TRANSACTION_DATE_TIME_REQUIRED(R.string.error_transaction_date_time_required),
    TRANSACTION_DATE_TIME_INVALID(R.string.error_transaction_date_time_invalid),
    TRANSACTION_SELECTION_REQUIRED(R.string.error_transaction_selection_required),
