...
| D001 (No Transport category for crop-farm costs) | **HANDED TO M4-05** | Minor; captured in M4-04 pilot Scenario B. Handed to M4-05 per M4-04 plan. See `M4_04_DEFECT_REGISTER.md`. |
