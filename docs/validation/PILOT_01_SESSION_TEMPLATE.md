...
| T11 find who owes | | | | | |
| T12 Activity interpretation | – | – | – | | – |
| T13 breakdown discovery route | | | | | |
...
| First path tried | | |
| Succeeded? | | |
| Forced into which workflow? | | |
| Abandoned? | | |
| Expected wording/action (their words) | | |

## 4. Terminology observations

| Term shown | Their interpretation | Consequence observed | Quote | State (SUPPORTED/PROBLEMATIC/INCONCLUSIVE) |
|---|---|---|---|---|
| लिन बाँकी | | | | |
| तिर्न बाँकी | | | | |
| चुक्ता | | | | |
...
Easiest · hardest · would-they-use-it · missing capabilities (their words):

## 9. Facilitator debrief notes

Anything affecting comparability (interruptions, device quirks, protocol deviations):
