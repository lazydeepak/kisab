...
- `DEFERRED / ACCEPTED IN M4-05` — evaluated with on-device evidence in M4-05 and accepted as-is with no production change; re-open criteria recorded in the disposition doc.
