...
| --- | --- |
| Global styling audit | Danger-button styling complete: wiring, full-surface sweep, and label-contrast rework (pressed `#FF5252`+`#212121` 5.05:1, disabled `#757575` dimmed, rest white 5.62:1) recorded in [validation](validation/STYLING_DANGER_BUTTON_WIRING_VALIDATION.md). Remaining MINOR items from the sweep: Add-Farm CREATE FARM dips under IME (scrollable form), small hardcoded paddings (4/6/8/9dp) bypass `spacing_*` scale. |
